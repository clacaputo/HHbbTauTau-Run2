...
// Wed Jan 16 11:44:16 2013 by ROOT version 5.26/00b
// from TTree vhtree/VH Analysis Tree
// found on file: /lustre/cms/store/user/sarkar/skim_cc/2012/MTT/WH_125/WH_125_1.root
//////////////////////////////////////////////////////////
...
const Int_t kMaxVertex = 300;
const Int_t kMaxElectron = 300;
const Int_t kMaxMuon = 300;
const Int_t kMaxTau = 300;
const Int_t kMaxJet = 300;
const Int_t kMaxMET = 1;
const Int_t kMaxTriggerObject = 100;
const Int_t kMaxSVDiTau = 1;
const Int_t kMaxGenParticle = 50000;
const Int_t kMaxGenJet = 3000;
...
public :
   ...
   Float_t         Tau_looseIsolation[kMaxTau];   //[Tau_]
   Float_t         Tau_mediumIsolation[kMaxTau];   //[Tau_]
   Float_t         Tau_tightIsolation[kMaxTau];   //[Tau_]
   ...
   Float_t         Tau_againstElectronMVA[kMaxTau];   //[Tau_]
   ...
   Float_t         Tau_byVLooseIsolationDeltaBetaCorr[kMaxTau];   //[Tau_]
   Float_t         Tau_byLooseIsolationDeltaBetaCorr[kMaxTau];   //[Tau_]
   Float_t         Tau_byMediumIsolationDeltaBetaCorr[kMaxTau];   //[Tau_]
   Float_t         Tau_byTightIsolationDeltaBetaCorr[kMaxTau];   //[Tau_]
...
*/
   ...
   TBranch        *b_Tau_byVLooseIsolationDeltaBetaCorr;   //!
   TBranch        *b_Tau_byLooseIsolationDeltaBetaCorr;   //!
   TBranch        *b_Tau_byMediumIsolationDeltaBetaCorr;   //!
   TBranch        *b_Tau_byTightIsolationDeltaBetaCorr;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lustre/cms/store/user/sarkar/skim_cc/2012/MTT/WH_125/WH_125_1.root");
      if (!f) {
         f = new TFile("/lustre/cms/store/user/sarkar/skim_cc/2012/MTT/WH_125/WH_125_1.root");
      }
...
*/
   ...
   fChain->SetBranchAddress("Tau.againstElectronMVA", Tau_againstElectronMVA, &b_Tau_againstElectronMVA);
   ...
   fChain->SetBranchAddress("Tau.byVLooseIsolationDeltaBetaCorr", Tau_byVLooseIsolationDeltaBetaCorr, &b_Tau_byVLooseIsolationDeltaBetaCorr);
   fChain->SetBranchAddress("Tau.byLooseIsolationDeltaBetaCorr", Tau_byLooseIsolationDeltaBetaCorr, &b_Tau_byLooseIsolationDeltaBetaCorr);
   fChain->SetBranchAddress("Tau.byMediumIsolationDeltaBetaCorr", Tau_byMediumIsolationDeltaBetaCorr, &b_Tau_byMediumIsolationDeltaBetaCorr);
   fChain->SetBranchAddress("Tau.byTightIsolationDeltaBetaCorr", Tau_byTightIsolationDeltaBetaCorr, &b_Tau_byTightIsolationDeltaBetaCorr);
