 ...
 *
 * Run2 code: Claudio Caputo (INFN Bari)
 * Copyright 2016 Claudio Caputo <cld.cpt@gmail.com>,
 * Run1 code: https://github.com/ajgilbert/ICHiggsTauTau/blob/master/Analysis/Utilities/src/BTagWeight.cc
 */
...
// namespace Run2{
  ...
  public:
    ...
    :bTagEffFile(root_ext::OpenRootFile(bTagEffName))
    {
     ...
     double Compute(const Run2::Sync& event){
