...
#include "../../../HTT-utilities/LepEffInterface/src/ScaleFactor.cc"
...
public:
          ...
          default_pu_weight(_default_pu_weight)
    {
        ...
        isoIdScaleFactor = new ScaleFactor();
        triggerScaleFactor = new ScaleFactor();
...
//            throw exception("Inconsistend event weight configuration: requested to apply PU weight for embedded sample.");
    ...
    void CalculateLeptonWeights (const Run2::Sync& eventInfo){
...
private:
    ...
    ScaleFactor * isoIdScaleFactor, *triggerScaleFactor;
};
