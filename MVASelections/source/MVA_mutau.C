...
void MVA_mutau(const std::string& filePath, const std::string& category_name)
{
    ...
    const std::string namePrefix = "./out_mutau_" + category_name + ".root";
    TString outfileName(namePrefix);
    TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

    const std::string mvaPrefix = "TMVA_muTau_" + category_name;
