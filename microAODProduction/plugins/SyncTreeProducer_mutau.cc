...
#include "HHbbTauTau/microAODProduction/interface/SyncTreeProducer_mutau.h"
...
double SyncTreeProducer_mutau::SVFit(const analysis::CandidateV2Ptr& higgs, const analysis::MissingETPtr& met){
