...
config.General.requestName = 'NewCode_ETau_v4_T2_Bari'
...
config.Data.outLFNDirBase = '/store/user/ccaputo/HHbbtautau/Run2/Sync_160407_NewCode/' # or '/store/group/<subdir>'
