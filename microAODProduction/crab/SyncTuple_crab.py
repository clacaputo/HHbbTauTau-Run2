...
config.General.requestName = 'SUSYGluGluToHToTauTau_M160_BJets'
...
config.Data.outLFNDirBase = '/store/user/ccaputo/HHbbtautau/Run2/160131_BJets/' # or '/store/group/<subdir>'
