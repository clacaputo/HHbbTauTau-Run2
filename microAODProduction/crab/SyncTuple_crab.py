...
config.General.requestName = 'SUSYGluGluToHToTauTau_M160_76X'
...
config.Data.outLFNDirBase = '/store/user/ccaputo/HHbbtautau/Run2/160206_Sync_76x_v1/' # or '/store/group/<subdir>'
