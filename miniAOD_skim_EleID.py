...
skimmedBranches = cms.untracked.vstring(['drop *',
                                         ...
                                         'keep floatedmValueMap_electronMVAValueMapProducer_*_USER', ## Value Map with the electrons ID MVA values 
...
process.out = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('allBranches_eleIDs_signal.root'),
