...
#define VERTEX_DATA() \
    ...
    SIMPLE_VAR(Double_t, xErr) \
    SIMPLE_VAR(Double_t, yErr) \
    SIMPLE_VAR(Double_t, zErr) \
    SIMPLE_VAR(Double_t, rho) \
    SIMPLE_VAR(Double_t, chi2) \
    SIMPLE_VAR(Double_t, ndf) \
    SIMPLE_VAR(UInt_t, ntracks) \
    SIMPLE_VAR(UInt_t, ntracksw05) \
    SIMPLE_VAR(Bool_t, isfake) \
    SIMPLE_VAR(Bool_t, isvalid) \
    SIMPLE_VAR(Double_t, sumPt) \
    SIMPLE_VAR(Double_t, sumPtSquared) \
    /**/
